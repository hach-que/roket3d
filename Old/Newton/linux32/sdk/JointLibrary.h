...
//	typedef struct NewtonCustomJoint{} NewtonCustomJoint;
    ...
    JOINTLIBRARY_API void DGRaycastVehicleAddTire (NewtonCustomJoint *car, void *userData, const dFloat* localPosition, dFloat mass, dFloat radius, dFloat width, dFloat friction, dFloat suspensionLimit, dFloat springConst, dFloat springDamper, int castMode);
	...
	JOINTLIBRARY_API void DGRaycastVehicleSetDefaultVar(NewtonCustomJoint *car, dFloat chassisRotationLimit, dFloat defaultEngineForce, dFloat defaultSteerForce);
