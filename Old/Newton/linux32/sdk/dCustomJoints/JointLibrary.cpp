...
void DGRaycastVehicleAddTire (NewtonCustomJoint *car, void *userData, const dFloat* localPosition, dFloat mass, dFloat radius, dFloat width, dFloat friction, dFloat suspensionLimit, dFloat springConst, dFloat springDamper, int castMode)
{
  ((CustomDGRayCastCar*)car)->AddSingleSuspensionTire(userData,localPosition,mass,radius,width,friction,suspensionLimit,springConst,springDamper,castMode);
}
...
void DGRaycastVehicleSetDefaultVar(NewtonCustomJoint *car, dFloat chassisRotationLimit, dFloat defaultEngineForce, dFloat defaultSteerForce)
{
  ((CustomDGRayCastCar*)car)->SetVehicleVar(chassisRotationLimit,defaultEngineForce,defaultSteerForce);
}
