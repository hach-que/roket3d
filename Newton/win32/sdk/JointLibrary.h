...
//	typedef struct NewtonCustomJoint{} NewtonCustomJoint;
    ...
    JOINTLIBRARY_API NewtonCustomJoint *DGRaycastVehicleCreate (int maxTireCount, int chassisAxis, int tractionAxis, int steerAxis, int frictionAxis, const dFloat* cordenateSytem, NewtonBody* carBody, const dFloat* gravity);
    JOINTLIBRARY_API void DGRaycastVehicleAddTire (NewtonCustomJoint *car, void *userData, const dFloat* localPosition, dFloat mass, dFloat radius, dFloat width, dFloat suspensionLength, dFloat springConst, dFloat springDamper, int castMode);
	...
	JOINTLIBRARY_API void DGRaycastVehicleSetTireBrake (NewtonCustomJoint *car, int index, dFloat torque);
    JOINTLIBRARY_API void DGRaycastVehicleSetTireTorque (NewtonCustomJoint *car, int index, dFloat torque);
    JOINTLIBRARY_API void DGRaycastVehicleSetTireSteerAngle (NewtonCustomJoint *car, int index, dFloat angle, dFloat turnforce);
