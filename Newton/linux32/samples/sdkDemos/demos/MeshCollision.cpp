...
//	LoadLevelAndSceneRoot (system, "flatplane.mdl", 1);
//	LoadLevelAndSceneRoot (system, "dungeon.mdl", 1);
	LoadLevelAndSceneRoot (system, "pitpool.mdl", 1);
//	LoadLevelAndSceneRoot (system, "playground.mdl", 1);
//	LoadLevelAndSceneRoot (system, "traybox.mdl", 1);
...
void SimplePlaneCollision (SceneManager& system)
{
	...
	// create the sky box and the floor,
	level = LoadLevelAndSceneRoot (system, "flatplane.mdl", 1);
...
void SimpleHeighMapColliion (SceneManager& system)
{
	...
	// create the sky box and the floor,
	level = LoadLevelAndSceneRoot (system, "flatplane.mdl", 0);
...
//	dSceneNode* scene;
	...
	// create the sky box and the floor,
	LoadSceneAndSceneRoot (system, "pitpool.mdl", 0);
...
//	dSceneNode* scene;
	...
	// create the sky box and the floor,
	LoadLevelAndSceneRoot (system, "flatplane.mdl", 0);
//	LoadLevelAndSceneRoot (system, "dungeon.mdl");
//	LoadLevelAndSceneRoot (system, "pitpool.mdl", 0);
//	LoadLevelAndSceneRoot (system, "playground.mdl", 0);
//	LoadLevelAndSceneRoot (system, "traybox.mdl");
