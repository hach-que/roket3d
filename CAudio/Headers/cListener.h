...
namespace cAudio
{
    ...
    {
    public:
        EXPORTDLL cListener static  &getInstance()
        {
        ...
        EXPORTDLL void setPosition(ALfloat x,ALfloat y, ALfloat z)
        {
            alListener3f(AL_POSITION,x,y,z);
        }
	    //!Sets the listeners orientation
        EXPORTDLL void setOrientation(ALfloat x,ALfloat y,ALfloat z,ALfloat upx,ALfloat upy,ALfloat upz)
        {
            ALfloat orientation[6] = {x,y,z,upx,upy,upz};
            alListenerfv(AL_ORIENTATION,orientation);
        }
	    //!Inits Mikmod and openal
        EXPORTDLL static void initaudio(int argc,char* argv[])
        {
            alutInit(&argc,argv);
	  /*
            ALCcontext *Context;
	...
	*/
        ...
        EXPORTDLL static void shutdownaudio()
        {
            alutExit();
        }
    };
